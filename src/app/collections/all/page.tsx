			...
			<div className='container' id='columns'>
				...
				<div className='row'>
					<div className='column col-xs-12 col-sm-4 col-md-3' id='left_column'>
						...
						<div className='block left-module'>
							<p className='title_block'>Lọc sản phẩm <i className='visible-xs fa fa-angle-down'
									aria-hidden='true'></i></p>
							<div className='block_content'>
									...
									<div className='layered-content filter-color'>
										<ul className='check-box-list'>
											...
											<li>
												...
												<label style={{backgroundColor: '#000000'}} htmlFor='color1'><span
											...
											<li>
												...
												<label style={{backgroundColor: '#ffffff'}} htmlFor='color2'><span
														className='button'></span></label>
											</li>
											...
											<li>
												...
												<label style={{backgroundColor: '#7ed321'}} htmlFor='color3'><span
														className='button'></span></label>
											</li>
											...
											<li>
												...
												<label style={{backgroundColor: '#bd10e0'}} htmlFor='color4'><span
														className='button'></span></label>
											</li>
											...
											<li>
												...
												<label style={{backgroundColor: '#539cf3'}} htmlFor='color5'><span
														className='button'></span></label>
											</li>
					...
					<div className='center_column col-xs-12 col-sm-8 col-md-9 product-col' id='center_column'>
						<div id='view-product-list' className='view-product-list'>
							<h2 className='page-heading'>
								<span className='page-heading-title'>Tất cả sản phẩm</span>
							</h2>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												<span>Nhà cung cấp: <strong>xerox</strong></span>
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													LPH FUJIFILM APEOS C3070/4570/5570 - CHÍNH HÃNG-017K05460
												</p>
											</div>
										</div>
									</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													BỘ NHÔNG QUAY HỘP DẪN MỰC THẢI XEROX 4570/5570/3070/3372
												</p>
											</div>
										</div>
									</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													TRỤC SANG ẢNH 2nd ROLLER XEROX 4471/4473/4570/5570 - 859K03831
												</p>
											</div>
										</div>
									</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													TRỤC SANG ẢNH 2nd ROLLER XEROX MÀU 2275/4475/7845 -859K03831
												</p>
											</div>
										</div>
									</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													CỤM ĐỒNG BỘ XEROX VI 2271/4471/4570/4473 - 859K03317
												</p>
											</div>
										</div>
									</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													CỤM GẠT BĂNG TẢI XEROX V80/180/2100/3100 CHÍNH HÃNG-042K94710
												</p>
											</div>
										</div>
									</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													GẠT BĂNG TẢI XEROX VI/VII 2271/3373/4570/5570 - CHÍNH HÃNG
												</p>
											</div>
										</div>
									</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													TRỤC SANG ẢNH 2ND XEROX V 3065/2560/C3060 - CHÍNH HÃNG - 019k16290
												</p>
											</div>
										</div>
									</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													MIẾNG SIU TEPXLON CHỊU NHIỆT KHỐI SẤY XEROX V 2275/4475/VI
													3371/4570/5570 - 9 LỖ
												</p>
											</div>
										</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													TRỤC ÉP XEROX MÀU V80/180/2100/3100 - CHÍNH HÃNG - 059k81320
												</p>
											</div>
										</div>
									</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													TRỤC SẤY XEROX V2060/3065/2263/2265/7035/7030 - CHÍNH HÃNG - KO BẠC
													ĐẠN
												</p>
											</div>
										</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													KHỐI DRUM XEROX B9100/B9136 -NHẬP KHẦU
												</p>
											</div>
										</div>
									</div>
									...
									<div className='product-container'>
										...
										<div className='product-info'>
											...
											<div className='detail-list'>
												...
												<span>Mã sản phẩm: <strong> Chưa rõ</strong></span>
												<p>
													NHỰA HƯỚNG GIẤY ĐẢO MẶT INVENTER DUPLEX XEROX 6080/7080 - 054K32798
												</p>
											</div>
										</div>
									</div>
